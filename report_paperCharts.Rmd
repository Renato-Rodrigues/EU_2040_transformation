...
g[["Industry Emissions"]] <- ggplot(plotData,aes(x=period,y=value)) +
    ...
    #theme(legend.text=element_text(size=theme.double.text.size)) +
    #theme(legend.text=element_text(size=theme.double.text.size))  +
    labs(title = expression(paste("(d) Industrial sectors’ ", CO[2], " emissions (Mt ", CO[2], "/yr)"))) #+
    #theme(plot.title = element_text(hjust=-0.3)) 
...
ggsave(paste0(outChartsFolder,"/svg/Figure 5. Milestones Panel.svg"), g[["milestone - hor targets"]] , device="svg", width = 12, height = 14, dpi=100, units = "in")
ggsave(paste0(outChartsFolder,"/png/Figure 5. Milestones Panel.png"), g[["milestone - hor targets"]] , device="png", width = 12, height = 14, dpi=300, units = "in")
