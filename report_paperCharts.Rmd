...
g[["2040 Net Emissions - Energy and Industrial Processes - horizontal bar - net only"]] <- plotData %>%
  ...
  theme(legend.position = "none",
        ...
        axis.title.y=element_blank(),
        plot.margin = margin(t = 15, r = 0, b = 100, l = 0, unit = "pt"),
        plot.title = element_text(margin=margin(t=0,r=0,b=55,l=0), hjust=1))
...
plotData <- rbind(
  df %>%
    filter(!grepl("limVRE", scenario), region == "EU27", period == 2040, tgt2030 %in% tgt2030Scen) %>%
    calc_addVariable( "`Emissions with LULUCF and with intra-EU aviation`" = "`Emi|GHG|LULUCF national accounting` + `Emi|CO2|Energy|Demand|Transport|International Bunkers|Intra-region`" , units = "Mt CO2/yr", only.new=T) %>%
...
### Supplementary figure 4. EU-27 Electricity capacity
...
g[["Supplementary figure 5"]] <- gridExtra::arrangeGrob(
 ...
 ggsave(paste0(outChartsFolder,"/svg/Supplementary figure 5. EU-27 Electricity generation.svg"), g[["Supplementary figure 5"]] , device="svg", width = 12, height = 9, dpi=100, units = "in")
 ggsave(paste0(outChartsFolder,"/png/Supplementary figure 5. EU-27 Electricity generation.png"), g[["Supplementary figure 5"]] , device="png", width = 12, height = 9, dpi=300, units = "in")
